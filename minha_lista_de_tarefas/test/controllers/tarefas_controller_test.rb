...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { descricao: @tarefa.descricao, nome: @tarefa.nome, string: @tarefa.string } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { descricao: @tarefa.descricao, nome: @tarefa.nome, string: @tarefa.string } }
